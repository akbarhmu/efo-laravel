                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            ...
                            @endif
                            <form class="form form-horizontal" method="POST" action="{{ route('admin.dashboard.users.store') }}">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="text" name="name" class="form-control" placeholder="Nama Lengkap"
                                                        id="first-name-horizontal-icon" value="{{ old('name') }}" required />
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="text" name="nik" class="form-control" placeholder="Nomor Induk Kependudukan"
                                                        id="first-name-horizontal-icon" value="{{ old('nik') }}" required />
                                                    <div class="form-control-icon">
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="email" name="email" class="form-control" placeholder="Alamat Email"
                                                        id="first-name-horizontal-icon" value="{{ old('email') }}" required />
                                                    <div class="form-control-icon">
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="date" name="birth_date" class="form-control" placeholder="Tanggal Lahir"
                                                        id="first-name-horizontal-icon" value="{{ old('birth_date') }}" required />
                                                    <div class="form-control-icon">
                                        ...
                                        <div class="col-md-4">
                                            <label for="first-name-horizontal-icon">Password</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                        ...
                                        <div class="col-md-4">
                                            <label for="first-name-horizontal-icon">Konfirmasi Password</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <textarea name="address" class="form-control" placeholder="Alamat Sesuai KTP"
                                                        id="first-name-horizontal-icon">{{ old('address') }}</textarea>
                                                    <div class="form-control-icon">
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <textarea name="tps_address" class="form-control" placeholder="Alamat TPS"
                                                        id="first-name-horizontal-icon">{{ old('tps_address') }}</textarea>
                                                    <div class="form-control-icon">
                                                        <i class="bi bi-compass"></i>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="text" name="tps_number" class="form-control" placeholder="Nomor TPS"
                                                        id="first-name-horizontal-icon" value="{{ old('tps_number') }}" />
                                                    <div class="form-control-icon">
